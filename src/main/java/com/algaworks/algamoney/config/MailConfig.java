...
/* Definiremos as propriedades complementares como Host, port, usuário e senha do email em
 * AlgamoneyApiProperty. Que serão configuradas em application.properties. */
